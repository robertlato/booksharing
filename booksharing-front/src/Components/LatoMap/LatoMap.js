    ...
    if (this.state.updateMap != this.props.updateMap) {
      if (this.props.data.length > 0) {
        ...
        for (var i = 0; i < this.props.data.length; i++) {
          ...
          var houseNumber = this.props.data[i].sharePoint.address.houseNumber;

          var url = "https://nominatim.openstreetmap.org/search?city=" + city + "&street=" + houseNumber + "%20" + street + "&format=json";
